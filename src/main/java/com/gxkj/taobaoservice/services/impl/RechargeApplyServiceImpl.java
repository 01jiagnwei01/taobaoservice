...
public class RechargeApplyServiceImpl implements RechargeApplyService {
	 ...
	 */
	  ...
	  * 审核拒绝
	  */
	public void doRefuseRechargeApply(Integer applyId, AdminUser adminUser,
	 ...
	 * 审核通过
	 */
	public void doAgreeRechargeApply(Integer applyId, AdminUser adminUser)
		...
		log.setAfterRestAmount(userAccount.getCurrentRestPoints() );
