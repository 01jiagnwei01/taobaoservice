...
var addUserBtn = "${_adminUser_.btnMap.userdoadd}"?true:false;
var updateUserBtn = "${_adminUser_.btnMap.userdoupdate}"?true:false;
var userdodel = "${_adminUser_.btnMap.userdodel}"?true:false;
var userdopage = "${_adminUser_.btnMap.userdopage}"?true:false;
var usersetpassword = "${_adminUser_.btnMap.usersetpassword}"?true:false;
